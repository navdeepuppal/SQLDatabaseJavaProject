    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            while (rs.next()) {
                ...
                jTextArea1.setText(jTextArea1.getText() + rs.getString(1) + "  " + rs.getString(2) + "  " + rs.getString(3) + "  " + rs.getString(4) + "\n");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       // INSERT INTO pet VALUES ('Puffball','Diane','hamster','f','1999-03-30',NULL);
        ...
        try {
            ...
            stmt.executeUpdate("insert into emp values(\'"+name+"\',\'"+email+"\',\'"+phno+"\',\'"+country+"\');");
...
System.out.println(e);
        ...
        JOptionPane.showMessageDialog(null, "New row has been inserted into the database ! ", "Data Inserted", JOptionPane.INFORMATION_MESSAGE);
